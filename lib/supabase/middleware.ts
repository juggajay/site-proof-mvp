...
export async function updateSession(request: NextRequest) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    // If Supabase env vars are missing, allow access to all pages
    // This prevents the blank screen issue when env vars are not configured
  ...
  try {
    ...
    // This prevents infinite redirects or blank screens
  }
